            ...
            child: FlatButton(
                onPressed: (){
                  if(_textFieldControllerQuestions.text == '' || _textFieldControllerAnswerA.text == '' || _textFieldControllerAnswerB.text == '' || _textFieldControllerAnswerC.text == '' || _textFieldControllerAnswerD.text == '' || _textFieldControllerAnswerE.text == '' || id == null){
                    ...
                    POST.postcreate(_textFieldControllerQuestions.text, id, widget.id, _textFieldControllerAnswerA.text, _textFieldControllerAnswerB.text, _textFieldControllerAnswerC.text, _textFieldControllerAnswerD.text, _textFieldControllerAnswerE.text);
